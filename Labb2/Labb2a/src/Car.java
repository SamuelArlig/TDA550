...
public abstract class Car implements Movable {
    ...
    protected Car(double x, double y, int nrDoors, double enginePower, Color color, String modelName, double turnSpeed,int size ){
        this(nrDoors,  enginePower,  color,  modelName,  turnSpeed, size);
