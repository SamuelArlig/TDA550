...
public abstract class Truck extends Car {
    ...
    protected Truck(double maxBedAngle, int nrDoors, double enginePower, Color color, String modelName, double turnSpeed){
        this(0, 0, maxBedAngle, nrDoors, enginePower, color, modelName, turnSpeed);
    }
    protected Truck(double x, double y, double maxBedAngle, int nrDoors, double enginePower, Color color, String modelName, double turnSpeed){
        super(x, y, nrDoors, enginePower, color, modelName, turnSpeed,2);
